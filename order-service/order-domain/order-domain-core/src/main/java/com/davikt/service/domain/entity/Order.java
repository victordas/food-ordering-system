package com.davikt.service.domain.entity;

import com.davikt.domain.entity.AggregateRoot;
import com.davikt.domain.valueobject.*;
import com.davikt.service.domain.exception.OrderDomainException;
import com.davikt.service.domain.valueobject.OrderItemId;
import com.davikt.service.domain.valueobject.StreetAddress;
import com.davikt.service.domain.valueobject.TrackingId;
...
public class Order extends AggregateRoot<OrderId> {
    ...
    private void validateItemsPrice() {
        ...
        if(!total.equals(orderItemsTotal)) {
            throw new OrderDomainException(String.format("Total price: %.2f must be equal to OrderItems total: %.2f.", total.getAmount(), orderItemsTotal.getAmount()));
        }
    }
